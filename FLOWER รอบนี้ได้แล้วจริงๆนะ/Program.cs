        ...
        while(true){
            ...
            if (Flower_bunch.Get(range) != 'J'&&Flower_bunch.Get(range) != 'G'&&Flower_bunch.Get(range) != 'R'&&Flower_bunch.Get(range) != 'O' ){
                ...
                if(Flower_bunch.Get(range)=='G'){
                    ...
                    else if (Flower_bunch.Get(range) == Flower_bunch.Get(0) && Flower_bunch.Get(range) == Flower_bunch.Get(1) && Flower_bunch.Get(range) == Flower_bunch.Get(range-1)){
                        Console.WriteLine("Invalid pattern");
                        Flower_bunch.Remove(range);
                    }
                    else if (Flower_bunch.Get(range) == Flower_bunch.Get(0) && Flower_bunch.Get(range) == Flower_bunch.Get(range-1) && Flower_bunch.Get(range) == Flower_bunch.Get(range-2)){
                        Console.WriteLine("Invalid pattern");
                        Flower_bunch.Remove(range);
                    }
